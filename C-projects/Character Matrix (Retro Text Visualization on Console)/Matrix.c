...
{      printf("\n\n");
    ...
    {
        for(k=1;k<=10;k++)         // this loop print the patteRn horizontally
       {   
           if(k<=3){        printf("      "); writegap(row);}
           else if(k==4){   printf("  "); writeM(row);}
           else if(k==5){   printf("  "); writeA(row);}
           else if(k==6){   printf("  "); writeT(row);}
           else if(k==7){   printf("  "); writeR(row);}
           else if(k==8){   printf("  "); writeI(row);}
           else if(k==9){   printf("  "); writeX(row);}
          else if(k==10){        printf("      "); writegap(row);}
